...
class Genre(models.Model): 
	...
	def __str__(self): 
		return self.name # метод _str_ () возвращает имя жанра, которое будет  внесено в конкретную запись.
...
class Status(models.Model): 
	name = models.CharField(max_length=20, help_text="Введите статус экземпляра книги", verbose_name="Cтaтyc экземпляра книги", choices=status_choices) 
	def __str__(self): 
		return self.name 
